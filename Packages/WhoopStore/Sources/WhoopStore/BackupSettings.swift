...
public enum BackupSettings {
    ...
    public static let whitelist: [String: Kind] = [
        ...
        // A measured VO2max and the calorie settings behind it. Per-person rather than per-device, so
        ...
        "profile.vo2max": .double,
        "calorie.model": .string,
        "calorie.preferOnDevice": .int,
        "calorie.dayActiveHRRFraction": .double,
        "calorie.boutActiveHRRFraction": .double,
        "calorie.activeAccrualMET": .double,
        "calorie.dynAccelMETGainPerG": .double,
        "calorie.hrFallbackWhenNoMET": .int,
        // The measured-basal model's own settings, one canonical key per field. That model is
        // Android-only, so this platform carries these values across a backup without reading them.
        "calorie.sessionGapS": .int,
        "calorie.minHrCoverageFrac": .double,
        "calorie.hampelRadiusS": .int,
        "calorie.hampelSigmas": .double,
        "calorie.suppressPeaks": .int,
        "calorie.peakBlockS": .int,
        "calorie.peakPercentile": .double,
        "calorie.motionStillG": .double,
        "calorie.motionSmoothS": .int,
        "calorie.basalMinWindowS": .int,
        "calorie.basalHrRangeBpm": .double,
        "calorie.basalStillFrac": .double,
        "calorie.basalBeatCoverageFrac": .double,
        "calorie.restSmoothS": .int,
        "calorie.restSmoothMinSamples": .int,
        "calorie.basalHrSeedOffsetBpm": .double,
        "calorie.reserveRampBandBpm": .double,
        "calorie.measuredBasalKcalDay": .double,
        "calorie.basalFatNight": .double,
        "calorie.basalFatDay": .double,
        "calorie.basalFatDayStartHour": .double,
        "calorie.basalFatDayEndHour": .double,
        "calorie.activeFatAtZone1": .double,
        "calorie.activeFatAtZone2Top": .double,
        "units.system": .string,
    ...
    public static let appleDefaultsKey: [String: String] = [
        ...
        // Carried on the wire before this platform edits them, so a backup that round-trips through
        // this device keeps settings only the other platform can write. `snapshot` omits any key this
        // device never set, so nothing is invented.
        "profile.vo2max": "profile.vo2maxOverride",
        "calorie.model": "calorie.model",
        "calorie.preferOnDevice": "calorie.preferOnDevice",
        "calorie.dayActiveHRRFraction": "calorie.dayActiveHRRFraction",
        "calorie.boutActiveHRRFraction": "calorie.boutActiveHRRFraction",
        "calorie.activeAccrualMET": "calorie.activeAccrualMET",
        "calorie.dynAccelMETGainPerG": "calorie.dynAccelMETGainPerG",
        "calorie.hrFallbackWhenNoMET": "calorie.hrFallbackWhenNoMET",
        "calorie.sessionGapS": "calorie.sessionGapS",
        "calorie.minHrCoverageFrac": "calorie.minHrCoverageFrac",
        "calorie.hampelRadiusS": "calorie.hampelRadiusS",
        "calorie.hampelSigmas": "calorie.hampelSigmas",
        "calorie.suppressPeaks": "calorie.suppressPeaks",
        "calorie.peakBlockS": "calorie.peakBlockS",
        "calorie.peakPercentile": "calorie.peakPercentile",
        "calorie.motionStillG": "calorie.motionStillG",
        "calorie.motionSmoothS": "calorie.motionSmoothS",
        "calorie.basalMinWindowS": "calorie.basalMinWindowS",
        "calorie.basalHrRangeBpm": "calorie.basalHrRangeBpm",
        "calorie.basalStillFrac": "calorie.basalStillFrac",
        "calorie.basalBeatCoverageFrac": "calorie.basalBeatCoverageFrac",
        "calorie.restSmoothS": "calorie.restSmoothS",
        "calorie.restSmoothMinSamples": "calorie.restSmoothMinSamples",
        "calorie.basalHrSeedOffsetBpm": "calorie.basalHrSeedOffsetBpm",
        "calorie.reserveRampBandBpm": "calorie.reserveRampBandBpm",
        "calorie.measuredBasalKcalDay": "calorie.measuredBasalKcalDay",
        "calorie.basalFatNight": "calorie.basalFatNight",
        "calorie.basalFatDay": "calorie.basalFatDay",
        "calorie.basalFatDayStartHour": "calorie.basalFatDayStartHour",
        "calorie.basalFatDayEndHour": "calorie.basalFatDayEndHour",
        "calorie.activeFatAtZone1": "calorie.activeFatAtZone1",
        "calorie.activeFatAtZone2Top": "calorie.activeFatAtZone2Top",
